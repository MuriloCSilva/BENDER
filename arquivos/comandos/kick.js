...
module.exports = {
    run: async (client, message, args) => {
        ...
        if (!message.guild.me.hasPermission("KICK_MEMBERS")){
            ...
            .setAuthor('Bender - Kick', 'https://cdn.discordapp.com/app-icons/854445481060859964/dd098f0dc533651ec93e8d34d7e01f03.png?size=64')
            .setColor('#3847F3')
            .setDescription('Erro! Eu não possuo permissão para expulsar membros <a:errado_animado:852530967419682826>')
        ...
        if (!message.member.permissions.has("KICK_MEMBERS")) {
            ...
            .setAuthor('Bender - Kick', 'https://cdn.discordapp.com/app-icons/854445481060859964/dd098f0dc533651ec93e8d34d7e01f03.png?size=64')
            .setColor('#3847F3')
            .setDescription('Erro! Você não possui permissão para expulsar membros <a:errado_animado:852530967419682826>')
            .setFooter('Feito com carinho por MX#0777')
        ...
        .then((collected) => {
            ...
            if (typeof verificaruser == 'number') {
                let user = message.guild.member(message.mentions.users.first()) || message.guild.members.get(idban)
                console.log(user)
                if (user) {
                    if (user.permissions.has("BAN_MEMBERS")) {
                        msgPrincipal.edit(
                            ...
                            .setAuthor('Bender - Kick', 'https://cdn.discordapp.com/app-icons/854445481060859964/dd098f0dc533651ec93e8d34d7e01f03.png?size=64')
                            .setColor('#3847F3')
                            .setDescription(`Erro! Voce está tentando expulsar um usuário que tambem possui permissão para expulsar <a:errado_animado:852530967419682826>`)
                            .setFooter('Feito com carinho por MX#0777')
                        );
                        return;
                    }
                    ...
                    if (!user.bannable) {
                        msgPrincipal.edit(
                            ...
                            .setAuthor('Bender - Kick', 'https://cdn.discordapp.com/app-icons/854445481060859964/dd098f0dc533651ec93e8d34d7e01f03.png?size=64')
                            .setColor('#3847F3')
                            .setDescription(`Erro! Voce está tentando expulsar um usuário acima de mim na hierarquia <a:errado_animado:852530967419682826>`)
                            .setFooter('Feito com carinho por MX#0777')
                        );
                        return;
                    } else user.ban({reason: "Responsável pela expulsão: "+message.author.username})
                    .then(() => {
                        msgPrincipal.edit(
                            new Discord.MessageEmbed()
                            .setAuthor('Bender - Kick', 'https://cdn.discordapp.com/app-icons/854445481060859964/dd098f0dc533651ec93e8d34d7e01f03.png?size=64')
